...
function ContactSection() {
  ...
  const inputBase = "w-full px-4 py-3 rounded-xl border bg-background/50 text-foreground placeholder:text-muted-foreground text-sm focus:outline-none transition-colors duration-200";
  const inputOk = "border-border/50 focus:border-primary/60 focus:ring-1 focus:ring-primary/30";
  const inputErr = "border-destructive/60 focus:border-destructive/80 focus:ring-1 focus:ring-destructive/30";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "contact", className: "py-24 relative overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-divider absolute top-0 left-0 right-0" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "orb orb-green w-[600px] h-[600px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-[0.06] pointer-events-none" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 lg:px-8 max-w-2xl relative z-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "scroll-reveal text-center mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl md:text-5xl font-black text-foreground mb-4", children: [
          "Get in ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Touch" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground", children: "Have questions? We'd love to hear from you." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "scroll-reveal delay-100 card-glass p-8 rounded-2xl", children: submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-foreground", children: "Message Sent!" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-sm max-w-xs leading-relaxed", children: [
              "We'll get back to you within 24 hours. In the meantime, feel free to explore our",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  onClick: () => {
                    var _a2;
                    return (_a2 = document.getElementById("faq")) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth" });
                  },
...
function EquityCurve() {
  const width = 450;
  const height = 100;
  const pts = EQUITY_POINTS.map(([x2, y]) => `${x2},${y}`).join(" ");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "curve-fill", x1: "0", y1: "0", x2: "0", y2: "1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "#00ff88", stopOpacity: "0.25" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "#00ff88", stopOpacity: "0" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("polygon", { points: fillPts, fill: "url(#curve-fill)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "polyline",
          {
            points: pts,
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 lg:px-8 relative z-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14 scroll-reveal", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary font-semibold text-sm uppercase tracking-widest mb-3", children: "Live Dashboard" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl md:text-5xl font-black text-foreground mb-4", children: [
              "Your Trading ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Command Center" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground max-w-xl mx-auto", children: "Every metric you need to evaluate performance, spot patterns, and improve your edge." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              style: {
                boxShadow: "0 0 60px rgba(0,255,136,0.12), 0 0 120px rgba(0,255,136,0.05), 0 30px 60px rgba(0,0,0,0.4)"
              },
              "data-ocid": "dashboard-card",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-6 pt-5 pb-4 border-b border-border/30", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-lg bg-primary/20 border border-primary/30 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary text-xs font-bold", children: "FX" }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-foreground text-sm", children: "TradeFXBook Dashboard" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Apr 13, 2026" }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-medium uppercase tracking-wider mb-2", children: "Today's PnL" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-end gap-2 mb-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl font-black text-emerald-400", children: "+$2,847.50" }) }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center gap-1 text-xs font-bold px-2 py-0.5 rounded-full bg-emerald-400/10 text-emerald-400", children: "▲ +12.4%" })
                        ]
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-medium uppercase tracking-wider mb-2", children: "Win Rate" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-black text-foreground mb-1", children: "67.8%" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Last 30 days" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 h-1.5 rounded-full bg-border/30 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-medium uppercase tracking-wider mb-3", children: "Trade Summary" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-sm", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Total Trades" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-foreground", children: "48" })
                            ] }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-sm", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Winning" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-emerald-400", children: "33" })
                            ] }),
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-sm", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Losing" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-red-400", children: "15" })
                            ] })
                          ] })
                        ]
                      }
                    ...
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-medium uppercase tracking-wider", children: "Equity Curve" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold px-2 py-0.5 rounded-full bg-emerald-400/10 text-emerald-400", children: "30D" })
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(EquityCurve, {})
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 py-3 border-b border-border/20", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-medium uppercase tracking-wider", children: "Recent Trades" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "button",
                            {
                              type: "button",
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-border/20", children: TRADE_LOG.map((trade) => {
                              ...
                              children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                                    "span",
                                    {
                                      className: `text-xs font-bold px-2 py-0.5 rounded ${trade.direction === "LONG" ? "bg-emerald-400/10 text-emerald-400" : "bg-red-400/10 text-red-400"}`,
                                      children: trade.direction
                                    }
                                  ),
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-foreground", children: trade.symbol })
                                ] }),
                                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-6 text-xs text-muted-foreground", children: [
                                  ...
                                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                                    "span",
                                    {
                                      className: `font-bold text-sm min-w-[80px] text-right ${isWin ? "text-emerald-400" : "text-red-400"}`,
                                      children: trade.pnl
                                    }
                                  )
                                ] })
...
function FAQSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "faq", className: "py-24 relative overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-divider absolute top-0 left-0 right-0" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 lg:px-8 max-w-3xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14 scroll-reveal", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl md:text-5xl font-black text-foreground mb-4", children: [
          "Frequently Asked ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Questions" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground", children: "Everything you need to know about TradeFXBook." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: faqs.map((faq, i) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: `scroll-reveal delay-${i % 4 * 100} rounded-xl border overflow-hidden transition-all duration-300 ${isOpen ? "border-primary/40 bg-card" : "border-border/40 bg-card/40 hover:border-border/70"}`,
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground text-sm md:text-base leading-snug", children: faq.q }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      ChevronDown,
                      {
                        className: `flex-shrink-0 w-5 h-5 transition-transform duration-300 ${isOpen ? "rotate-180 text-primary" : "text-muted-foreground"}`
                      }
                    )
                  ]
                }
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "px-6 pb-5 text-sm text-muted-foreground leading-relaxed", children: faq.a })
                }
              )
            ]
          },
...
function useScrollRevealGroup(count, options) {
...
const features = [
  {
    ...
    description: "Test strategies on real historical data. Pick symbol, timeframe, replay candle by candle.",
    bullets: [
  ...
  },
  {
    ...
    description: "Add notes, tag strategy, attach screenshots, track emotions. Every trade tells a story.",
    bullets: ["Screenshot attachments", "Emotion tracking", "Strategy tagging"]
  },
  {
    icon: TrendingUp,
    title: "Powerful Analytics",
    description: "Equity curves, calendar heatmaps, session breakdowns, profit factor, risk/reward — auto-calculated.",
    bullets: ["Equity curve charts", "Win rate by session", "Profit factor"]
  },
  {
    icon: Zap,
    title: "MT5 Real-Time Sync",
    description: "Link MT4/MT5 account, trades appear automatically. No copy-paste. Supports multiple accounts.",
    bullets: ["Auto-sync trades", "Multiple accounts", "No manual entry"]
  },
  {
    icon: Brain,
    title: "AI-Powered Reports",
    description: "AI reads your trades, gives full breakdown — what's working, what's not, what to focus on.",
    bullets: ["Pattern recognition", "Personalized insights", "Weekly reports"]
  },
  {
    icon: Users,
    title: "Community & Leaderboard",
    description: "Real-time chat, trade sharing, weekly/monthly leaderboards, Traders Lounge for mentoring.",
    bullets: ["Weekly leaderboards", "Trade sharing", "Mentoring access"]
  }
];
const DELAY_CLASSES$1 = [
  "delay-100",
  "delay-200",
  "delay-300",
  "delay-400",
...
function FeaturesSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "features", className: "py-24 relative overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-divider absolute top-0 left-0 right-0" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "orb orb-green w-[700px] h-[700px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-5 pointer-events-none" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 lg:px-8 relative z-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-primary/30 bg-primary/10 text-primary text-sm font-semibold mb-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-primary" }),
              "Platform Features"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl md:text-5xl font-black text-foreground mb-4 leading-tight", children: [
              "Everything You Need to",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Master Your Trading" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed", children: "Built for serious traders. Every tool designed to give you the edge that separates professionals from the rest." })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: features.map((feature, i) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            className: `scroll-reveal ${DELAY_CLASSES$1[i]} card-glass group p-6 flex flex-col gap-4`,
            "data-ocid": `feature-card-${i}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-xl bg-primary/15 border border-primary/25 flex items-center justify-center flex-shrink-0 transition-all duration-300 group-hover:bg-primary/25 group-hover:border-primary/50 group-hover:shadow-[0_0_20px_rgba(0,255,136,0.2)]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-6 h-6 text-primary", strokeWidth: 1.75 }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold text-foreground leading-snug", children: feature.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: feature.description })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-auto space-y-2 pt-2 border-t border-border/30", children: feature.bullets.map((bullet) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "li",
                {
                  className: "flex items-center gap-2.5 text-sm",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-shrink-0 w-4 h-4 rounded-full bg-primary/20 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Check,
                      {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground/75", children: bullet })
                  ]
                },
                bullet
              )) })
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-white/5 bg-card/20 py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 md:grid-cols-5 gap-8 mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-2 md:col-span-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-primary/20 border border-primary/30 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary text-xs font-black", children: "FX" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-bold text-lg text-foreground tracking-tight", children: [
            "Trade",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "FX" }),
            "Book"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground leading-relaxed mb-5 max-w-[180px]", children: "The premium trading journal for serious forex traders worldwide." }),
      ...
      Object.entries(footerLinks).map(([category, links]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-bold text-foreground mb-4 tracking-wide", children: category }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " TradeFXBook. All rights reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
...
function useCountUp(target, duration = 2e3, enabled = true) {
...
function StatBox({
  ...
  const display = isDecimal ? `${prefix2 ?? ""}${count.toFixed(1)}${suffix2 ?? ""}` : `${prefix2 ?? ""}${count.toLocaleString()}${suffix2 ?? ""}`;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "stat-number text-2xl md:text-3xl text-primary mb-0.5", children: value ?? display }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-medium uppercase tracking-wider", children: label })
      ]
    }
  );
}
...
function HeroSection() {
  ...
  const [tradersCount] = reactExports.useState(12400);
  const [tradesCount] = reactExports.useState(847e3);
  const [pnlCount] = reactExports.useState(2.4);
  reactExports.useEffect(() => {
  ...
  const pnlVal = useCountUp(pnlCount * 10, 2e3, inView);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      id: "hero",
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 lg:px-8 relative z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "h1",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: "The Trading Journal" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "That Works For You" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "scroll-reveal delay-200 text-xl md:text-2xl font-semibold text-muted-foreground mb-4 tracking-tight", children: [
            "Track Trades. ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: "Analyze PnL." }),
            " ",
            "Master Markets."
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "scroll-reveal delay-300 text-base md:text-lg text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed", children: "Sync your trades, journal every setup, backtest ideas, and let AI do the analysis — all in one powerful command center." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "scroll-reveal delay-400 flex items-center justify-center gap-3 mb-12", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex -space-x-2", children: AVATARS.map((a) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-semibold", children: "Join 12,400+" }),
              " ",
              "top traders"
            ] })
          ] }),
...
const steps = [
  {
    ...
    description: "Link your MT4/MT5 broker account with read-only investor password. Zero risk.",
  ...
  },
  {
    ...
    description: "Your trades sync automatically every minute. Add journal notes and strategy tags.",
  ...
  },
  {
    ...
    description: "AI analyzes your performance patterns and gives actionable recommendations.",
    color: "from-purple-500/20 to-purple-500/5",
    glow: "rgba(168,85,247,0.15)"
  }
];
const DELAY_CLASSES = ["delay-100", "delay-200", "delay-300"];
function HowItWorksSection() {
  const headerRef = useScrollReveal();
  const stepRefs = useScrollRevealGroup(steps.length);
  const connectorRef = reactExports.useRef(null);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "how-it-works", className: "py-24 relative overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-divider absolute top-0 left-0 right-0" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-section-gradient pointer-events-none" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "orb orb-green w-[600px] h-[400px] bottom-0 right-0 translate-x-1/2 opacity-6 pointer-events-none" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 lg:px-8 relative z-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl md:text-5xl font-black text-foreground mb-4 leading-tight", children: [
              "Get Started in ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Minutes" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground max-w-xl mx-auto leading-relaxed", children: "No complex setup. No IT knowledge required. From broker connection to your first AI insight in under 5 minutes." })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-5xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            "aria-hidden": "true",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full bg-gradient-to-r from-primary/60 via-blue-500/40 to-purple-500/60" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/2 left-1/4 -translate-y-1/2 w-2 h-2 rounded-full bg-primary/60 animate-pulse" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-6", children: steps.map((step, i) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              "data-ocid": `step-${i + 1}`,
              children: [
                i < steps.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden absolute -bottom-5 left-1/2 -translate-x-1/2 text-primary/40 text-xl font-bold z-10", children: "↓" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mb-6", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-1 -right-1 w-8 h-8 rounded-full bg-background border-2 border-primary flex items-center justify-center shadow-[0_0_12px_rgba(0,255,136,0.4)]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-black text-[11px] leading-none", children: step.number }) })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2 max-w-[280px]", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-bold text-primary tracking-[0.15em] uppercase", children: [
                    "Step ",
                    step.number,
                    " — ",
                    step.title
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-black text-foreground leading-tight", children: step.headline }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: step.description })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none -z-10 border border-primary/10 bg-primary/3" })
              ]
            },
            step.number
          );
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "scroll-reveal delay-400 text-center mt-16", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-3 font-medium", children: "No credit card required · 14-day free trial" })
      ] })
    ] })
  ] });
}
function useTheme() {
  const { theme, setTheme, resolvedTheme, systemTheme } = z();
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      "data-ocid": "navbar",
      className: `fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? "navbar-scrolled bg-background/80 border-b border-border/30" : "bg-transparent"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16 lg:h-20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-primary/20 border border-primary/30 flex items-center justify-center group-hover:shadow-glow-sm transition-all duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "w-4 h-4 text-primary" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-bold text-xl tracking-tight text-foreground", children: [
                  "Trade",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "FX" }),
                  "Book"
                ] })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex md:hidden items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: isMobileOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-4 h-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { className: "w-4 h-4" })
              }
            )
          ] })
        ] }) }),
        isMobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-4 flex flex-col gap-1", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-2 mt-2 border-t border-border/30 flex flex-col gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
...
function PricingSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "pricing", className: "py-24 relative overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-divider absolute top-0 left-0 right-0" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "orb orb-green w-[600px] h-[600px] -bottom-60 left-1/2 -translate-x-1/2 opacity-10 pointer-events-none" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12 scroll-reveal", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl md:text-5xl font-black text-foreground mb-4", children: [
          "Plans for ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Every Trader" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground mb-8", children: "Start free, scale as you grow. Cancel anytime." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  className: `px-5 py-2 rounded-full text-sm font-semibold transition-all duration-300 ${!isAnnual ? "bg-primary text-primary-foreground shadow-sm" : "text-muted-foreground hover:text-foreground"}`,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  className: `px-5 py-2 rounded-full text-sm font-semibold transition-all duration-300 flex items-center gap-2 ${isAnnual ? "bg-primary text-primary-foreground shadow-sm" : "text-muted-foreground hover:text-foreground"}`,
                  "data-ocid": "toggle-yearly",
                  children: [
                    "Yearly",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs bg-primary/20 text-primary px-2 py-0.5 rounded-full font-bold", children: "Save 17%" })
                  ]
                }
              )
            ]
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto items-center", children: plans.map((plan, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: `relative rounded-2xl p-6 scroll-reveal delay-${i * 100} transition-all duration-300 ${plan.featured ? "border border-primary/40 bg-card md:scale-105 md:py-8" : "border border-border/40 bg-card/60 hover:border-primary/30"}`,
          "data-ocid": `pricing-${plan.name.toLowerCase()}`,
          style: plan.featured ? {
            boxShadow: "0 0 0 1px rgba(0,255,136,0.3), 0 20px 60px rgba(0,0,0,0.3), 0 0 40px rgba(0,255,136,0.1)"
          } : {},
          children: [
            plan.featured && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-3.5 left-1/2 -translate-x-1/2 px-4 py-1 bg-primary text-primary-foreground text-xs font-bold rounded-full whitespace-nowrap", children: "Most Popular" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-foreground mb-0.5", children: plan.name }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "span",
                  {
                    className: `text-4xl font-black price-transition ${plan.featured ? "gradient-text" : "text-foreground"}`,
                    children: [
                      "$",
              ...
              isAnnual && plan.annualBilled > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-primary mt-1 font-medium", children: [
                "Billed $",
                plan.annualBilled,
                "/yr"
              ] }),
              !isAnnual && plan.monthly === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Free forever" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2.5 mb-8", children: plan.features.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2.5 text-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Check,
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                className: `w-full py-3 rounded-xl text-sm font-bold transition-all duration-300 ${plan.ctaStyle === "neon" ? "btn-neon" : "btn-neon-outline"}`,
                children: plan.cta
              }
            )
          ]
...
function StatItem({ stat, enabled }) {
  ...
  const formatted = stat.decimals === 1 ? (raw / 10).toFixed(1) : raw.toLocaleString();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm md:text-base font-semibold text-foreground/80 tracking-wide mt-1", children: stat.label }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-0.5 bg-primary/40 rounded-full mt-1 transition-all duration-300 group-hover:w-16 group-hover:bg-primary/80" })
      ]
    }
  );
}
function StatsBar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      "data-ocid": "stats-bar",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-card via-background to-card opacity-95" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-primary/5 via-transparent to-primary/5" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-divider absolute top-0 left-0 right-0" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-divider absolute bottom-0 left-0 right-0" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "orb orb-green w-[400px] h-[200px] top-1/2 left-1/4 -translate-y-1/2 opacity-8 pointer-events-none" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "orb orb-blue w-[300px] h-[200px] top-1/2 right-1/4 -translate-y-1/2 opacity-6 pointer-events-none" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 lg:px-8 relative z-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: triggerRef, className: "sr-only", "aria-hidden": "true" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ref: innerRef,
              className: "scroll-reveal grid grid-cols-2 md:grid-cols-4 gap-10 md:gap-6",
              children: stats.map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsx(StatItem, { stat, enabled: isVisible }, stat.label))
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-xs text-muted-foreground/60 mt-10 font-medium tracking-widest uppercase", children: "Trusted by professional traders worldwide" })
        ] })
      ]
    }
  );
...
function LandingPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(DashboardPreviewSection, {}),
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    J,
    {
      ...
      enableSystem: false,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollRevealManager, {}),
